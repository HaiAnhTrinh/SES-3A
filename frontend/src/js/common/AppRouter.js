    ...
    <BrowserRouter>
      <Switch>
        ...
        <Route
          ...
          exact
          strict
          render={props => <SupplierLoginPage {...props} />}
        />
        <Route
          path='/Vendor/:email'
          render={props => (isLoggedIn ? <VendorLayout {...props} /> : <Redirect to='/' />)}
        />
        <Route
          path='/Supplier/:email'
          render={props => (isLoggedIn ? <SupplierLayout {...props} /> : <Redirect to='/' />)}
        />
        <Route
          path='/App/:email'
          render={props => (isLoggedIn ? <AppLayout {...props} /> : <Redirect to='/' />)}
        />
