...
export default function Home() {
  ...
  const [list, setList] = useState([
    ...
    },
    {
      id: 2,
      title: 'Pizza',
      url: 'https://cdn.pixabay.com/photo/2014/05/18/11/25/pizza-346985__340.jpg',
      price: '$30',
      by: 'test@gmail.com'
    },
    {
      id: 3,
      title: 'Hotdog',
      url: 'https://cdn.pixabay.com/photo/2017/05/31/08/34/breakfast-2359474__340.jpg',
      price: '$30',
      by: 'test@gmail.com'
    }
  ])
    ...
    <div className='container'>
      ...
      {isShowList ? (
        <div className='list-wrapper'>
          <ul className='list'>
            {list.map(l => (
              <li onClick={handleShowDetail} className='li' key={l.id}>
                <div className='title'>{l.title}</div>
                <img src={l.url} className='img' />
                <div className='desc'>
                  <div className='left'>
                    <div className='price'>{l.price}</div>
                    <div className='by'>By：{l.by}</div>
                  </div>
                  <div className='right'>
        ...
        <DialogContent className='dialog-content'>
          <Card className='product-detail-wrapper'>
            <CardHeader
              ...
              title='Some thing'
              subheader={`By: ${currentUser?.email}`}
            />
            <CardMedia
              className='media'
            ...
            <CardContent>
              <img
                ...
                src='https://cdn.pixabay.com/photo/2015/12/08/00/26/food-1081707_960_720.jpg'
              />
              <div>Description:package of 1kg new</div>
              <div>Remaining stock: 290</div>
              <div>Price: $15</div>
            </CardContent>
