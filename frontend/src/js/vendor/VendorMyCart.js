...
export default function MyCart(props){
    ...
    console.log(props);
    const [valueAddedItem, setValueAddedItem] = useState(1);
	...
	const onItemQuantityChanged = (event) => setValueAddedItem(parseInt(event.target.value));
    ...
    const onAddItemButtonClick = (e) => {
        props.history.push("/VendorMyStock");
    };

	const onClickRemoveItem = (e) => {
	     e.preventDefault();
	    };
	const onIncrementAddedItem = (e) => {
        e.preventDefault();
        setValueAddedItem(valueAddedItem + 1);
    };

    const onDecrementAddedItem = (e) => {
        e.preventDefault();
        setValueAddedItem(valueAddedItem - 1);
    };
    ...
    return(
        ...
        <div  class="my-cart-actions-holder-div">
          ...
          <table class="my-cart-table-heading">
          <tr>
          	<th class="my-cart-placeholder-for-sub-title my-cart-subtitle-font" > Remove </th>
          	<th class="my-cart-placeholder-for-sub-title my-cart-subtitle-font"> Items </th>
          	<th class="my-cart-placeholder-for-sub-title my-cart-subtitle-font"> Price</th>
            <th class="my-cart-placeholder-for-sub-title my-cart-subtitle-font"> Supplier</th>
            <th class="my-cart-placeholder-for-sub-title my-cart-subtitle-font"> Quantity</th>
          </tr>

          <tr id="cartPageItemHolder" class="my-cart-items-box-holder my-cart-items-description-div">
                	   <td>
                	     <span class="my-cart-add-button-item" onClick={onClickRemoveItem}>-</span>
                	   </td>
                     ...
                     <td> Supplier </td>
                  	 ...
                  	 <td>
                  	     <span class="my-cart-add-button-item" onClick={onIncrementAddedItem}>+</span>
                  	     <span class="my-cart-item-quantity-holder"><TextField class="my-cart-item-quantity-textfield" onChange={onItemQuantityChanged} value={valueAddedItem} label="" variant="filled" /></span>
                  	     <span class="my-cart-add-button-item" onClick={onDecrementAddedItem}>-</span>
                  	 </td>
            </tr>
          </table>
          ...
          <div class="my-cart-total-price-div">
            <div class="my-cart-text-total-price">Total Price </div>
            <TextField  variant="filled" readOnly="{true}" value="" />
          </div>
