...
export default function MyCart(props) {
  ...
  const onClickRemoveItem = (event, productName, supplierEmail) => {
    ...
    console.log(data)
    Axios.post('http://localhost:8080/RemoveFromCart', data, {
      headers: { 'Content-Type': 'application/json' }
    })
      .then(response => {
        console.log(response)
  ...
  return (
    <div>
      ...
      <div class='my-cart-actions-holder-div'>
        ...
        <div
          className={proceedPayment ? 'hide-class-payment-button' : 'my-cart-proceed-payment-div'}
        >
          <Button
            type='submit'
            variant='contained'
            color='primary'
            size='large'
            onClick={onProceedToPaymentButtonClick}
          >
            PROCEED TO PAYMENT
          </Button>
        </div>
      ...
      <div
        className={
          proceedPayment ? 'my-cart-payment-information-box' : 'my-cart-proceed-payment-div-hide'
        }
      >
        <div class='my-cart-heading-payment-info'>Payment Information</div>
        ...
        <div class='my-cart-payment-details-div-box'>
          <div class='my-cart-payment-info-details-box'>
            <div class='my-cart-payment-info-details-title'>Credit Cards Accepted</div>
            <div class='my-cart-payment-info-details-title'>Card Number</div>
            <div class='my-cart-payment-info-details-title'>Expiry Date (MM)</div>
            <div class='my-cart-payment-info-details-title'>CVV</div>
            <div class='my-cart-payment-info-details-title'>Name On Card</div>
            <div class='my-cart-payment-info-details-title'>Country</div>
            <div class='my-cart-payment-info-details-title'>Address 1</div>
            <div class='my-cart-payment-info-details-title'>Address 2</div>
            <div class='my-cart-payment-info-details-title'>City</div>
            <div class='my-cart-payment-info-details-title'>State</div>
            <div class='my-cart-payment-info-details-title'>Postal Code</div>
            <div class='my-cart-payment-info-details-title'>Contact Phone Number</div>
            <div class='my-cart-payment-info-details-title'>Email Address</div>
          </div>
          ...
          <div class='my-cart-payment-info-filling-box'>
            <div class='my-cart-payment-info-filling-details-text'>
              <input
                type='radio'
                name='site_name'
                checked={paymentCard === 'Visa'}
                onClick={handlePaymentCardOption}
                value='Visa'
              />
              ...
              <input
                type='radio'
                name='site_name'
                checked={paymentCard === 'MasterCard'}
                onClick={handlePaymentCardOption}
                value='MasterCard'
              />
