...
import VendorBar from '@material-ui/core/AppBar'
  ...
  return (
    <React.Fragment>
      <div className={classes.root}>
        <CssBaseline />
        <VendorBar position='fixed' className={classes.VendorBar}>
          <Toolbar>
            <IconButton
              color='inherit'
        ...
        <nav className={classes.drawer}>
          {/* The implementation can be swVendored with js to avoid SEO duplication of links. */}
